...
t = h5read('/disk/hyk049/DHM_new_1Dcenter/Q_1D_0p04vpp_a.h5', '/t')';
x = h5read('/disk/hyk049/DHM_new_1Dcenter/Q_1D_0p04vpp_a.h5', '/x')';
nx = length(x);

Q_a_1D = h5read('/disk/hyk049/DHM_new_1Dcenter/Q_1D_0p04vpp_a.h5', '/Q_1D')';
Q_b_1D = h5read('/disk/hyk049/DHM_new_1Dcenter/Q_1D_0p04vpp_b.h5', '/Q_1D')';
Q_c_1D = h5read('/disk/hyk049/DHM_new_1Dcenter/Q_1D_0p04vpp_c.h5', '/Q_1D')';
Q_d_1D = h5read('/disk/hyk049/DHM_new_1Dcenter/Q_1D_0p04vpp_d.h5', '/Q_1D')';
Q_e_1D = h5read('/disk/hyk049/DHM_new_1Dcenter/Q_1D_0p04vpp_e.h5', '/Q_1D')';
Q_f_1D = h5read('/disk/hyk049/DHM_new_1Dcenter/Q_1D_0p04vpp_f.h5', '/Q_1D')';
Q_g_1D = h5read('/disk/hyk049/DHM_new_1Dcenter/Q_1D_0p04vpp_g.h5', '/Q_1D')';
Q_h_1D = h5read('/disk/hyk049/DHM_new_1Dcenter/Q_1D_0p04vpp_h.h5', '/Q_1D')';
Q_i_1D = h5read('/disk/hyk049/DHM_new_1Dcenter/Q_1D_0p04vpp_i.h5', '/Q_1D')';
Q_j_1D = h5read('/disk/hyk049/DHM_new_1Dcenter/Q_1D_0p04vpp_j.h5', '/Q_1D')';
